...
| **四进一出适配器** | 我个人觉得Bambulab P1系列用的那种最好用，理论上任何可用的适配器都行，甚至3D打印的也可以 |
...
有一天，我在考虑给3D打印机加个缓冲器。突然灵光一现：四个挤出机加一个缓冲器基本上就等于一个完美的多色系统。这比基于伺服的方案更简单稳定，还解决了所有烦人的同步问题。说实话，都不用我多说——看看Bambulab、Creality这些厂商的做法，你会发现他们基本也是这个思路。
